...
let length = Object.keys(students);
console.log(length);

// 11. Can you define a key of `let or var` in any object? Reason.

//yes you can define any js keyword inside objects as keys as it is allowed . Not only that you can also define keys with integer name such as 69.
